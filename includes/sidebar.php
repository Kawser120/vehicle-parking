<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="<?php if($page=="in-vehicle") {echo "active";}?>"><a href="#"><em class="fa fa-toggle-on">&nbsp;</em> IN Vehicles</a></li>
            <li class="<?php if($page=="out-vehicle") {echo "active";}?>"><a href="#"><em class="fa fa-toggle-off">&nbsp;</em> OUT Vehicles</a></li>
